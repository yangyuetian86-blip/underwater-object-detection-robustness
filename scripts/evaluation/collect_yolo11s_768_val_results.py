...
def main():
    ...
    for i in range(1, 6):
        csv_path = runs_dir / f"yolo11s_768_train_fold_{i}" / "results.csv"
    ...
    save_path = runs_dir / "yolo11s_768_kfold_val_summary.csv"
    ...
    print(f"\nYOLO11s_768 val 结果已保存到: {save_path}")
